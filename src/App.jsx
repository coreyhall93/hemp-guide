...
const PRODUCTS = [
  ...
  // === CORNBREAD HEMP GUMMIES ===
  {
    ...
    compounds: [
      ...
      { abbr: "THC", mg: 1, role: "Trace" },
    ],
    totalMg: 26, psychoactive: false, drugTestRisk: "Yes (trace THC)",
  ...
  },
  {
    ...
    onset: "30-60 min", duration: "4-6 hrs",
    medFlag: "medium",
    medNote: "25mg CBD inhibits CYP2B6 (bupropion) and CYP2C19 (sertraline). Valerian adds sedation that stacks with sertraline. Bedtime only.",
    coreyNote: "You haven't tried this. CBD-driven sleep formula with calming botanicals at a 25:1 CBD:THC ratio. Lower CBD load than I previously had recorded.",
